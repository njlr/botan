...
#define BOTAN_VERSION_VC_REVISION \\"git:e7e130c3d56eead0d2f9e9cd5d00541a9c7fd006\\"
...
#define BOTAN_LIB_LINK \\"-ldl -framework Security\\"
...
genrule(
  name = 'macos-build.h',
  out = 'build.h',
  cmd = 'echo "' + MACOS_BUILD_H + '" > $OUT',
)

macos_sources = []

windows_sources = glob([
  'src/lib/entropy/cryptoapi_rng/**/*.cpp',
  'src/lib/entropy/win32_stats/**/*.cpp',
])
...
cxx_library(
  name = 'botan',
  header_namespace = 'botan',
  exported_headers = subdir_glob([
    ('src/lib/asn1', '**/*.h'),
    ('src/lib/base', '**/*.h'),
    ('src/lib/block', '*.h'),
    ('src/lib/block/aes', '**/*.h'),
    ('src/lib/block/blowfish', '**/*.h'),
    ('src/lib/block/camellia', '**/*.h'),
    ('src/lib/block/cascade', '**/*.h'),
    ('src/lib/block/cast', '**/*.h'),
    ('src/lib/block/des', '**/*.h'),
    ('src/lib/block/gost_28147', '**/*.h'),
    ('src/lib/block/idea', '**/*.h'),
    ('src/lib/block/kasumi', '**/*.h'),
    ('src/lib/block/lion', '**/*.h'),
    ('src/lib/block/misty1', '**/*.h'),
    ('src/lib/block/noekeon', '**/*.h'),
    ('src/lib/block/seed', '**/*.h'),
    ('src/lib/block/serpent', '**/*.h'),
    ('src/lib/block/threefish', '**/*.h'),
    ('src/lib/block/twofish', '**/*.h'),
    ('src/lib/block/xtea', '**/*.h'),
    ('src/lib/codec/base64', '**/*.h'),
    ('src/lib/codec/hex', '**/*.h'),
    ('src/lib/compression', '*.h'),
    ('src/lib/compression/bzip2', '**/*.h'),
    ('src/lib/compression/lzma', '**/*.h'),
    ('src/lib/compression/zlib', '**/*.h'),
    ('src/lib/entropy', '**/*.h'),
    ('src/lib/ffi', '**/*.h'),
    ('src/lib/filters', '*.h'),
    ('src/lib/filters/codec_filt', '**/*.h'),
    ('src/lib/filters/fd_unix', '**/*.h'),
    ('src/lib/hash', '*.h'),
    ('src/lib/hash/blake2', '**/*.h'),
    ('src/lib/hash/checksum/adler32', '**/*.h'),
    ('src/lib/hash/checksum/crc24', '**/*.h'),
    ('src/lib/hash/checksum/crc32', '**/*.h'),
    ('src/lib/hash/comb4p', '**/*.h'),
    ('src/lib/hash/gost_3411', '**/*.h'),
    ('src/lib/hash/keccak', '**/*.h'),
    ('src/lib/hash/md4', '**/*.h'),
    ('src/lib/hash/md5', '**/*.h'),
    ('src/lib/hash/mdx_hash', '**/*.h'),
    ('src/lib/hash/par_hash', '**/*.h'),
    ('src/lib/hash/rmd160', '**/*.h'),
    ('src/lib/hash/sha1', '**/*.h'),
    ('src/lib/hash/sha2_32', '**/*.h'),
    ('src/lib/hash/sha2_64', '**/*.h'),
    ('src/lib/hash/sha3', '**/*.h'),
    ('src/lib/hash/shake', '**/*.h'),
    ('src/lib/hash/skein', '**/*.h'),
    ('src/lib/hash/tiger', '**/*.h'),
    ('src/lib/hash/whirlpool', '**/*.h'),
    ('src/lib/kdf', '*.h'),
    ('src/lib/kdf/hkdf', '**/*.h'),
    ('src/lib/kdf/kdf1', '**/*.h'),
    ('src/lib/kdf/kdf1_iso18033', '**/*.h'),
    ('src/lib/kdf/kdf2', '**/*.h'),
    ('src/lib/kdf/prf_tls', '**/*.h'),
    ('src/lib/kdf/prf_x942', '**/*.h'),
    ('src/lib/kdf/sp800_56c', '**/*.h'),
    ('src/lib/kdf/sp800_108', '**/*.h'),
    ('src/lib/mac', '*.h'),
    ('src/lib/mac/cbc_mac', '*.h'),
    ('src/lib/mac/cmac', '*.h'),
    ('src/lib/mac/gmac', '*.h'),
    ('src/lib/mac/hmac', '*.h'),
    ('src/lib/mac/poly1305', '*.h'),
    ('src/lib/mac/siphash', '*.h'),
    ('src/lib/mac/x919_mac', '*.h'),
    ('src/lib/math/bigint', '**/*.h'),
    ('src/lib/math/ec_gfp', '**/*.h'),
    ('src/lib/math/mp', '**/*.h'),
    ('src/lib/math/numbertheory', '**/*.h'),
    ('src/lib/misc/aont', '**/*.h'),
    ('src/lib/misc/cryptobox', '**/*.h'),
    ('src/lib/misc/fpe_fe1', '**/*.h'),
    ('src/lib/misc/rfc3394', '**/*.h'),
    ('src/lib/misc/srp6', '**/*.h'),
    ('src/lib/misc/tss', '**/*.h'),
    ('src/lib/modes', '*.h'),
    ('src/lib/modes/aead', '*.h'),
    ('src/lib/modes/aead/ccm', '**/*.h'),
    ('src/lib/modes/aead/chacha20poly1305', '**/*.h'),
    ('src/lib/modes/aead/eax', '**/*.h'),
    ('src/lib/modes/aead/gcm/clmul', '**/*.h'),
    ('src/lib/modes/aead/gcm', '*.h'),
    ('src/lib/modes/aead/ocb', '**/*.h'),
    ('src/lib/modes/aead/siv', '**/*.h'),
    ('src/lib/modes/cbc', '**/*.h'),
    ('src/lib/modes/cfb', '**/*.h'),
    ('src/lib/modes/mode_pad', '**/*.h'),
    ('src/lib/modes/xts', '**/*.h'),
    ('src/lib/passhash/bcrypt', '**/*.h'),
    ('src/lib/passhash/passhash9', '**/*.h'),
    ('src/lib/pbkdf', '*.h'),
    ('src/lib/pbkdf/pbkdf1', '**/*.h'),
    ('src/lib/pbkdf/pbkdf2', '**/*.h'),
    ('src/lib/pk_pad', '*.h'),
    ('src/lib/pk_pad/eme_oaep', '**/*.h'),
    ('src/lib/pk_pad/eme_pkcs1', '**/*.h'),
    ('src/lib/pk_pad/eme_raw', '**/*.h'),
    ('src/lib/pk_pad/emsa1', '**/*.h'),
    ('src/lib/pk_pad/emsa_pkcs1', '**/*.h'),
    ('src/lib/pk_pad/emsa_pssr', '**/*.h'),
    ('src/lib/pk_pad/emsa_raw', '**/*.h'),
    ('src/lib/pk_pad/emsa_x931', '**/*.h'),
    ('src/lib/pk_pad/hash_id', '**/*.h'),
    ('src/lib/pk_pad/iso9796', '**/*.h'),
    ('src/lib/pk_pad/mgf1', '**/*.h'),
    ('src/lib/prov/pkcs11', '**/*.h'),
    ('src/lib/prov/tpm', '**/*.h'),
    ('src/lib/pubkey', '*.h'),
    ('src/lib/pubkey/cecpq1', '**/*.h'),
    ('src/lib/pubkey/curve25519', '**/*.h'),
    ('src/lib/pubkey/dh', '**/*.h'),
    ('src/lib/pubkey/dl_algo', '**/*.h'),
    ('src/lib/pubkey/dl_group', '**/*.h'),
    ('src/lib/pubkey/dlies', '**/*.h'),
    ('src/lib/pubkey/dsa', '**/*.h'),
    ('src/lib/pubkey/ec_group', '**/*.h'),
    ('src/lib/pubkey/ecc_key', '**/*.h'),
    ('src/lib/pubkey/ecdh', '**/*.h'),
    ('src/lib/pubkey/ecdsa', '**/*.h'),
    ('src/lib/pubkey/ecgdsa', '**/*.h'),
    ('src/lib/pubkey/ecies', '**/*.h'),
    ('src/lib/pubkey/eckcdsa', '**/*.h'),
    ('src/lib/pubkey/elgamal', '**/*.h'),
    ('src/lib/pubkey/gost_3410', '**/*.h'),
    ('src/lib/pubkey/keypair', '**/*.h'),
    ('src/lib/pubkey/mce', '**/*.h'),
    ('src/lib/pubkey/mceies', '**/*.h'),
    ('src/lib/pubkey/newhope', '**/*.h'),
    ('src/lib/pubkey/pbes2', '**/*.h'),
    ('src/lib/pubkey/pem', '**/*.h'),
    ('src/lib/pubkey/rfc6979', '**/*.h'),
    ('src/lib/pubkey/rsa', '**/*.h'),
    ('src/lib/pubkey/xmss', '**/*.h'),
    ('src/lib/rng', '*.h'),
    ('src/lib/rng/auto_rng', '**/*.h'),
    ('src/lib/rng/hmac_drbg', '**/*.h'),
    ('src/lib/rng/rdrand_rng', '**/*.h'),
    ('src/lib/rng/stateful_rng', '**/*.h'),
    ('src/lib/rng/system_rng', '**/*.h'),
    ('src/lib/stream', '*.h'),
    ('src/lib/stream/chacha', '**/*.h'),
    ('src/lib/stream/ctr', '**/*.h'),
    ('src/lib/stream/ofb', '**/*.h'),
    ('src/lib/stream/rc4', '**/*.h'),
    ('src/lib/stream/salsa20', '**/*.h'),
    ('src/lib/stream/shake_cipher', '**/*.h'),
    ('src/lib/tls', '*.h'),
    ('src/lib/tls/sessions_sql', '**/*.h'),
    ('src/lib/tls/sessions_sqlite3', '**/*.h'),
    ('src/lib/tls/tls_cbc', '**/*.h'),
    ('src/lib/utils', '*.h'),
    ('src/lib/utils/boost', '**/*.h'),
    ('src/lib/utils/dyn_load', '**/*.h'),
    ('src/lib/utils/http_util', '**/*.h'),
    ('src/lib/utils/locking_allocator', '**/*.h'),
    ('src/lib/utils/simd', '**/*.h'),
    ('src/lib/utils/sqlite3', '**/*.h'),
    ('src/lib/x509', '*.h'),
    ('src/lib/x509/certstor_sql', '*.h'),
    ('src/lib/x509/certstor_sqlite3', '*.h'),
  ]),
  exported_platform_headers = [
    ('default', { 'build.h': ':macos-build.h' }),
    ('^macos.*', { 'build.h': ':macos-build.h' }),
  ],
  headers = subdir_glob([
    ('src/lib/compression', '*.h'),
    ('src/lib/block/cast', '**/*.h'),
    ('src/lib/block/serpent', '**/*.h'),
    ('src/lib/entropy/cryptoapi_rng', '**/*.h'),
    ('src/lib/entropy/darwin_secrandom', '**/*.h'),
    ('src/lib/entropy/dev_random', '**/*.h'),
    ('src/lib/entropy/proc_walk', '**/*.h'),
    ('src/lib/entropy/rdrand', '**/*.h'),
    ('src/lib/entropy/rdseed', '**/*.h'),
    ('src/lib/entropy/win32_stats', '**/*.h'),
    ('src/lib/filters', '*.h'),
    ('src/lib/math/mp', '**/*.h'),
    ('src/lib/math/numbertheory', '**/*.h'),
    ('src/lib/modes/aead/ccm', '**/*.h'),
  ...
  excludes = platform_sources + glob([
    'src/lib/prov/openssl/**/*.cpp',
    'src/lib/prov/tpm/**/*.cpp',
  ])),
  platform_srcs = [
